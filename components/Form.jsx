  ...
  return (
    <div className={style.form} style={{ backgroundColor: color }}>
      ...
      <select className={`${style.select} text-white`} name={`${topic}-Template-${dayMonthYear}`} onChange={manageTemplate} style={{ fontWeight: 'bold', }}>
        <option value="#" selected={value == "TemplateOne" ? true : false}>Ninguno-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic    }</option>
        <option value="TemplateOne" selected={value == "TemplateOne" ? true : false}>Plantilla 1-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic}</option>
        <option value="TemplateThreeA" selected={value == "TemplateThreeA" ? true : false}>Plantilla 2-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic}</option>
        <option value="TemplateThreeB" selected={value == "TemplateThreeB" ? true : false}>Plantilla 3-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic}</option>
        <option value="TemplateFour" selected={value == "TemplateFour" ? true : false}>Plantilla 4-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic}</option>
        <option value="TemplateFive" selected={value == "TemplateFive" ? true : false}>Plantilla 5-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic}</option>
        <option value="TemplateSix" selected={value == "TemplateSix" ? true : false}>Plantilla 6-{topic == 'GestionDeGobierno' ? 'GESTIÓN DE GOBIERNO' :topic == 'Salud' ? 'Ciudades': topic == 'Salud' ? 'Ciudades': topic}</option>
