            ...
            <div className={style.container}>
                <nav className={`${style.nav}`} style={{ padding: '0 100px', position: 'relative' }}>
                    <Link href="/" legacyBehavior scroll={false}>
                        <a className={` absolute pt-[10px] h-[50px] top-0 left-[0px] ${pathname == "#Sociedad" ? style.active : ''}`} onClick={handlerClick}>
                            <span className=' h-[50px] rounded-full flex justify-center items-center bg-white rounded'><img src={'/inicio_v2.jpeg'} className="block h-[50px] rounded-full cursor-pointer" onClick={() => router.push('/')} alt="" /></span>
                        </a>
                    </Link>
